...
- [x] [`document.ts` merges responses through a hardcoded `204`](#documentts-merges-responses-through-a-hardcoded-204)
...
- [x] [`securitySchemes` reaches no generated client](#securityschemes-reaches-no-generated-client)
