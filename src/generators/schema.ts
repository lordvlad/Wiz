...
export function irToJsonSchema(ir: TypeIR, draft: "draft-2020-12" | "draft-07"): Record<string, unknown> {
...
function collectDefsForSchema(ir: TypeIR, draft: "draft-2020-12" | "draft-07"): Record<string, unknown> | undefined {
