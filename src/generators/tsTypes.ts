...
function objectText(
  ...
  if (members.length === 0) {
    ...
    return index ?? (ir.additionalProperties === false
      ? "Record<string, never>"
      : "Record<string, unknown>");
  }
