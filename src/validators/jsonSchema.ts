...
const validateOpenApi30 = buildValidatorFunction(openApi30Schema as unknown as Record<string, unknown>);
const validateOpenApi31 = buildValidatorFunction(openApi31Schema as unknown as Record<string, unknown>);
const validateOpenRpc13 = buildValidatorFunction(openRpc13Schema as unknown as Record<string, unknown>);
const validateAsyncApi26 = buildValidatorFunction(asyncApi26Schema as unknown as Record<string, unknown>);
const validateAsyncApi30 = buildValidatorFunction(asyncApi30Schema as unknown as Record<string, unknown>);
 ...
 */
export async function validateSpecDocument(doc: unknown, schemaHint?: string): Promise<ValidationResult> {
 ...
 */
export function assertValidSpecDocumentSync(doc: unknown, contextName = "Spec", schemaHint?: string): void {
 ...
 */
export async function assertValidSpecDocument(doc: unknown, contextName = "Spec", schemaHint?: string): Promise<void> {
