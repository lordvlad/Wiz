...
const queryIR: TypeIR = {
  ...
  kind: "object",
  properties: [
    { name: "page", optional: true, readonly: false, type: { id: "p1", kind: "primitive", type: "number" } },
    { name: "active", optional: true, readonly: false, type: { id: "p2", kind: "primitive", type: "boolean" } },
    { name: "count", optional: true, readonly: false, type: { id: "p3", kind: "primitive", type: "bigint" } },
    { name: "created", optional: true, readonly: false, type: { id: "p4", kind: "primitive", type: "date" } },
    {
      name: "tags",
      optional: true,
      readonly: false,
