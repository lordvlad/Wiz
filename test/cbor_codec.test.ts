...
const unhex = (s: string) => new Uint8Array((s.match(/../g) ?? []).map((pair) => parseInt(pair, 16)));
...
describe("CBOR codec (encodeCbor / decodeCbor)", () => {
    test("encodes RFC 8949 Appendix A vectors byte-for-byte", () => {
        const cases: Array<[unknown, string]> = [
            ...
            [new Date("2013-03-21T20:04:00.000Z"), "c07818323031332d30332d32315432303a30343a30302e3030305a"],
        ];
