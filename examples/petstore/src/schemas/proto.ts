 ...
 * no gRPC service to declare. `grpcSchema<[Service]>()` is what turns the
 * `@grpc`-tagged members of a TypeScript service into `service`/`rpc` blocks,
 * and consuming a `.proto` that declares services is the other direction, which
